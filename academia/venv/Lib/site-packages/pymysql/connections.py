    ...
    def _request_authentication(self):
        ...
        if auth_packet.is_auth_switch_request():
            ...
            if self._auth_plugin_name == "caching_sha2_password":
                ...
                raise err.OperationalError(
                    "Received extra packet for auth method %r",
        ...
        if handler:
            try:
                ...
                if plugin_name != b"dialog":
                    raise err.OperationalError(
                        CR.CR_AUTH_PLUGIN_CANNOT_LOAD, f"Authentication plugin '{plugin_name}'"
            ...
            while True:
                ...
                if prompt == b"Password: ":
                    ...
                    try:
                        ...
                        raise err.OperationalError(
                            CR.CR_AUTH_PLUGIN_ERR, f"Authentication plugin '{plugin_name}'"
